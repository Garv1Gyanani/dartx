<script>
  ...
  const features = [
    { title: 'Pre-compiled Routing', desc: 'Pre-built middleware chains during startup for extreme throughput.', icon: '🚀' },
    { title: 'ORM Relationships', desc: 'Declarative "belongsTo" and "hasMany" support for complex data models.', icon: '🗄️' },
    { title: 'Universal Caching', desc: 'Elegant "Cache" facade with built-in Memory and Redis drivers.', icon: '🚄' },
    { title: 'Declarative Validation', desc: 'Validate input using simple string rules like "required|email|min:8".', icon: '✅' },
    { title: 'Native Sessions', desc: 'Secure server-side cookie sessions with persistent storage support.', icon: '🛡️' },
    { title: 'CLI Scaffolding', desc: 'Rapidly generate models, migrations, and controllers with one command.', icon: '⚙️' }
  ];
...
<nav class="navbar" class:scrolled>
  <div class="container nav-content">
    ...
    <div class="nav-links">
      ...
      <a href="https://github.com/Garv1Gyanani/dartx" target="_blank" class="github-link">
  ...
  <main class="animate-fade-in">
    <section class="hero container">
      <div class="hero-content">
        <a href="https://pub.dev/packages/kronix" target="_blank" class="badge">v0.2.0 "Venom" Released</a>
        ...
        <div class="glass quick-start">
            ...
            <div class="quick-start-terminal">
                ...
                <div class="terminal-body">
                    ...
                    <p><span class="prompt">$</span> cd my_api && kronix make:model User -m</p>
                    <p class="success">🚀 Server ready on http://0.0.0.0:3000</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="glass bench-card">
            ...
            <div class="chart">
                <div class="bar-group">
                    ...
                    <div class="bar-wrapper"><div class="bar primary" style="width: 24%"></div></div>
                    <div class="bar-value">1.2 µs</div>
                </div>
                <div class="bar-group">
                    <div class="bar-label">Validation</div>
                    <div class="bar-wrapper"><div class="bar primary" style="width: 72%"></div></div>
                    <div class="bar-value">3.6 µs</div>
                </div>
                <div class="bar-group">
    ...
    <div class="container footer-content">
        ...
        <div class="footer-links">
            ...
            <div>
                <h4>Ecosystem</h4>
                <ul>
                    <li><a href="https://github.com/Garv1Gyanani/dartx">GitHub</a></li>
                    <li><a href="https://pub.dev/packages/kronix">Pub.dev</a></li>
                    <li><a href="#/docs">CLI Tool</a></li>
                </ul>
            </div>
            <div>
                <h4>Legal</h4>
